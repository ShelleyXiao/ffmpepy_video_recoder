 ...
 * 
 */
package com.zx.androidffmpegrecoder.songstudio.util;
...
public class DesEncode {
	...
	private static String encode(String key, byte[] data) throws Exception {
		...
		try{
			...
			String encodeStr = com.zx.androidffmpegrecoder.songstudio.util.Base64.encode(bytes);
	...
	public static String decode(String key, String data) throws Exception {
		...
		try{
			...
			datas = decode(key, 
					com.zx.androidffmpegrecoder.songstudio.util.Base64.decode(data));
		}
