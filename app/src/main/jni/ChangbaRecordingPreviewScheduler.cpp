#include "com_zx_androidffmpegrecoder_songstudio_recording_camera_preview_ChangbaRecordingPreviewScheduler.h"
...
JNIEXPORT void JNICALL Java_com_zx_androidffmpegrecoder_songstudio_recording_camera_preview_ChangbaRecordingPreviewScheduler_hotConfig(
    ...
    LOGI(" %s", "Java_com_zx_androidffmpegrecoder_songstudio_recording_camera_preview_ChangbaRecordingPreviewScheduler_hotConfig");
    if (NULL != previewController) {
        previewController->hotConfig(bitRate, fps, gopSize);
    }
}

JNIEXPORT void JNICALL Java_com_zx_androidffmpegrecoder_songstudio_recording_camera_preview_ChangbaRecordingPreviewScheduler_setBeautifyParam(JNIEnv* env, jobject obj, jint key, jfloat value) {
	LOGI("Java_com_zx_androidffmpegrecoder_songstudio_recording_camera_preview_ChangbaRecordingPreviewScheduler_setBeautifyParam");
